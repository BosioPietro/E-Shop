        ...
        <main class="flex-row al-c">
            ...
            <div class="flex-col al-c jc-c grow" id="cont-login">
                ...
                <div class="cella-input flex-col jc-c">
                    <label for="username">E-mail o Username</label>
                ...
                <button class="btn accento" onclick="login()" id="invia">Accedi</button>
                <h4>Non hai un account? <a href="javascript:passaRegistrati()">Registrati</a></h4>
            </div>
        </main>
    </section>
